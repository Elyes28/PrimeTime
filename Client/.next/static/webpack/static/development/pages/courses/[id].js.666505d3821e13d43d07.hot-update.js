      ...
      return _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              axios__WEBPACK_IMPORTED_MODULE_6___default.a.get("http://localhost:2895/courses/retreivecourseteachers/".concat(ctx.query.id)).then(function () {
                console.log('test');
              });
...
//# sourceMappingURL=[id].js.666505d3821e13d43d07.hot-update.js.map