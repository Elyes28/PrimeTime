...
function CoursesDetails(props) {
  ...
  var getCourses = function getCourses() {
    axios__WEBPACK_IMPORTED_MODULE_6___default.a.get("http://localhost:2895/courses/".concat(id)).then(function (response) {
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              console.log('id', id);
              _context.next = 3;
              return axios__WEBPACK_IMPORTED_MODULE_6___default.a.get("http://localhost:2895/courses/retreivecourseteachers/".concat(id)).then(function (response) {
...
CoursesDetails.getInitialrops = function () {};
...
//# sourceMappingURL=[id].js.1f25176d6a076172dde5.hot-update.js.map