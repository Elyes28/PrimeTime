...
function CoursesDetails(_ref) {
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_2__["useEffect"])(function () {
    if (courses) setCourses(coursesListe);
    if (teachers) console.log('techers', teachers);
  }, []);
    ...
    return _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.next = 2;
            return axios__WEBPACK_IMPORTED_MODULE_6___default.a.get("http://localhost:2895/courses/".concat(ctx.query.id));

          case 2:
            res = _context2.sent;
            _context2.next = 5;
            return axios__WEBPACK_IMPORTED_MODULE_6___default.a.get("http://localhost:2895/courses/retreivecourseteachers/".concat(ctx.query.id));
...
//# sourceMappingURL=[id].js.00fedd428cd020443c14.hot-update.js.map