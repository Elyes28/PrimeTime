...
function CoursesDetails(_ref) {
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_3__["useEffect"])(function () {
    ...
    getCoursesTeachers() */
    console.log(ctx);
    var res = axios__WEBPACK_IMPORTED_MODULE_7___default.a.get("http://localhost:2895/courses/".concat(ctx.query.id)).then( /*#__PURE__*/function () {
        ...
        return _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                setCourses(res.data);
                resTeachers = axios__WEBPACK_IMPORTED_MODULE_7___default.a.get("http://localhost:2895/courses/retreivecourseteachers/".concat(ctx.query.id)).then(function (res) {
  ...
  }, "Address"), __jsx(reactstrap__WEBPACK_IMPORTED_MODULE_4__["Input"], {
    className: "form-control",
    id: "inputAddress",
...
//# sourceMappingURL=[id].js.d46dc30da3664674db56.hot-update.js.map