...
function CoursesDetails(props) {
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_2__["useEffect"])(function () {
    ...
    getCoursesTeachers() */
    console.log(id);
    /* const res = Axios.get(`http://localhost:2895/courses/${
        ctx.query.id
    }`).then(async (res) => {
        setCourses(res.data)
        const resTeachers = Axios.get(`http://localhost:2895/courses/retreivecourseteachers/${
            ctx.query.id
        }`).then((res) => {
...
//# sourceMappingURL=[id].js.1127607c34808669eb70.hot-update.js.map