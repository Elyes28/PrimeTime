...
var PortfolioDetail7 = function PortfolioDetail7() {
      ...
      return _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_8___default.a.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              return _context.abrupt("return", axios__WEBPACK_IMPORTED_MODULE_13___default.a.get("http://localhost:5000/stream/getStreamByName/" + JSON.parse(localStorage.getItem("user"))["firstName"] + JSON.parse(localStorage.getItem("user"))["firstName"]).then(function (res) {
                setCourses(res.data);
  ...
  return __jsx(react__WEBPACK_IMPORTED_MODULE_10__["Fragment"], {
    ...
    className: " mr-3 border border-2",
    style: {
      width: "40%"
    },
    __self: _this,
    ...
    className: " mx-3 border border-2",
    style: {
      width: "55%"
    },
    __self: _this,
...
//# sourceMappingURL=profileDetails.js.1476dd93fcdb4f98bf3e.hot-update.js.map