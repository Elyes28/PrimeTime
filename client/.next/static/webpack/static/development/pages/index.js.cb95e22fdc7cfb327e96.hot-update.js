...
var Popup = function Popup() {
  ...
  var signin = function signin() {
    ...
    axios__WEBPACK_IMPORTED_MODULE_11___default.a.post("http://localhost:5000/user/signin", {
      ...
      console.log(res.data);
      setButtonValue("aaa"); // current_user.bro=res.data.result.token;
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_9__["useEffect"])(function () {//Runs on every render
  }); //
  ...
  }, "Login")))))), __jsx(reactstrap__WEBPACK_IMPORTED_MODULE_10__["Modal"], {
    isOpen: modal,
    toggle: toggle,
    __self: _this,
    __source: {
...
//# sourceMappingURL=index.js.cb95e22fdc7cfb327e96.hot-update.js.map