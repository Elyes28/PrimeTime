...
var PortfolioDetail7 = function PortfolioDetail7() {
  ...
  var sendUpdateRequest = function sendUpdateRequest() {
    ...
    axios__WEBPACK_IMPORTED_MODULE_11___default.a.post("http://localhost:5000/user/updateProfile", userData).then(function () {
      ...
      user.spotify = userData.spotify; // setUser(user)
  ...
  }, "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.") : __jsx("textarea", {
    __self: _this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 318,
...
//# sourceMappingURL=profileDetails.js.4da65a757b8ba652408b.hot-update.js.map