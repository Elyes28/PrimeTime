...
var PortfolioDetail7 = function PortfolioDetail7() {
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_0__["useEffect"])(function () {
    if (user) {
      ...
      if (JSON.parse(localStorage.getItem("user"))['expiration']) setExpires(JSON.parse(localStorage.getItem("user"))['expiration'].split('T')[0]);
    }
  }, [user]);
...
//# sourceMappingURL=profileDetails.js.4e5499f077e427f040a2.hot-update.js.map