...
var PortfolioDetail7 = function PortfolioDetail7() {
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_0__["useEffect"])(function () {
    if (user) {
      ...
      if (JSON.parse(localStorage.getItem("user"))['role']) setExpires(JSON.parse(localStorage.getItem("user"))['expiration'].split('T')[0]);
    }
  }, [user]);
...
//# sourceMappingURL=profileDetails.js.40be97e1c7d4c0e44ad0.hot-update.js.map