...
var PortfolioDetail7 = function PortfolioDetail7() {
  ...
  var getRecord = function getRecord(meetid) {
    axios__WEBPACK_IMPORTED_MODULE_13___default.a.get('http://localhost:5000/stream/fetchSessions/' + meetid).then(res);
  };
  ...
  return __jsx(react__WEBPACK_IMPORTED_MODULE_10__["Fragment"], {
    ...
    var recordpath = getRecord(recordedstream.meetingId);
    return __jsx("div", {
...
//# sourceMappingURL=profileDetails.js.5380a1398e578f27ca97.hot-update.js.map