...
var PortfolioDetail7 = function PortfolioDetail7() {
  ...
  var sendUpdateRequest = function sendUpdateRequest() {
    ...
    axios__WEBPACK_IMPORTED_MODULE_12___default.a.post("localhost:5000/user/updateProfile", userData).then(function () {
      setUser.apply(void 0, Object(_babel_runtime_corejs2_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_8__["default"])(user).concat([userData]));
      localStorage.setItem('user', _babel_runtime_corejs2_core_js_json_stringify__WEBPACK_IMPORTED_MODULE_7___default()(userData));
    });
...
//# sourceMappingURL=profileDetails.js.4e98aacbe7a55137857f.hot-update.js.map