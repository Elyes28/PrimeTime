          ...
          switch (_context.prev = _context.next) {
            case 0:
              return _context.abrupt("return", axios__WEBPACK_IMPORTED_MODULE_13___default.a.get("http://localhost:5000/user/getCurrentStream/" + para).then(function (res) {
                setStream(res.data.currentstream); //  axios.get("http://localhost:5000/stream/getStreamById/"+res.data.meetingId)
                //      .then(ress => {
                //          setStream(ress.data);
...
//# sourceMappingURL=channel.js.58493c085a0347c762b3.hot-update.js.map