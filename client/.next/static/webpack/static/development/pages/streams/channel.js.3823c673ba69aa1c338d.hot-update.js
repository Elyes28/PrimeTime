...
/* harmony import */ var _database__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./database */ "./pages/streams/database.js");
/* harmony import */ var _database__WEBPACK_IMPORTED_MODULE_15___default = /*#__PURE__*/__webpack_require__.n(_database__WEBPACK_IMPORTED_MODULE_15__);
...
var PortfolioDetail2 = function PortfolioDetail2() {
  ...
  var _userState = userState(),
      _userState2 = Object(_babel_runtime_corejs2_helpers_esm_slicedToArray__WEBPACK_IMPORTED_MODULE_10__["default"])(_userState, 2),
      streamer = _userState2[0],
      setStreamer = _userState2[1];
      ...
      return _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_8___default.a.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              return _context.abrupt("return", axios__WEBPACK_IMPORTED_MODULE_13___default.a.get("http://localhost:5000/user/getCurrentStream/" + para).then(function (res) {
                setStream(res.data.currentstream);
                setStreamer(res.data.streamer); //  axios.get("http://localhost:5000/stream/getStreamById/"+res.data.meetingId)
                //      .then(ress => {
                //          setStream(ress.data);
  ...
  var _useState3 = Object(react__WEBPACK_IMPORTED_MODULE_11__["useState"])(initilindex),
      photoIndex = _useState3[0],
      setPhotoIndex = _useState3[1];

  return __jsx(_containers_common_common_layout__WEBPACK_IMPORTED_MODULE_12__["default"], {
  ...
  }, __jsx(react__WEBPACK_IMPORTED_MODULE_11__["Fragment"], {
    __self: _this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 96,
  ...
  }, __jsx(react_slick__WEBPACK_IMPORTED_MODULE_14___default.a, Object(_babel_runtime_corejs2_helpers_esm_extends__WEBPACK_IMPORTED_MODULE_7__["default"])({
  ...
  }), _database__WEBPACK_IMPORTED_MODULE_15__["PortfolioDetail1Data"].map(function (data, i) {
    return __jsx("div", {
      className: "item",
      key: i,
      __self: _this,
...
//# sourceMappingURL=channel.js.3823c673ba69aa1c338d.hot-update.js.map