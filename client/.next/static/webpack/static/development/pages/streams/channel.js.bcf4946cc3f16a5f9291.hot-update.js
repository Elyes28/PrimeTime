      ...
      return _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_8___default.a.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              return _context.abrupt("return", axios__WEBPACK_IMPORTED_MODULE_12___default.a.get("http://localhost:5000/user/getCurrentStream/" + para).then(function (res) {//  axios.get("http://localhost:5000/stream/getStreamById/"+res.data.meetingId)
                //      .then(ress => {
                //          setStream(ress.data);
...
//# sourceMappingURL=channel.js.bcf4946cc3f16a5f9291.hot-update.js.map