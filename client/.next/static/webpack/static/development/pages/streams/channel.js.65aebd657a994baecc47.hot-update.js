      ...
      return _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_8___default.a.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              return _context2.abrupt("return", axios__WEBPACK_IMPORTED_MODULE_12___default.a.get("http://localhost:5000/stream/getStreamByName/" + streamer.firstName + " " + JSON.parse(localStorage.getItem("user"))["lastName"]).then(function (res) {
...
//# sourceMappingURL=channel.js.65aebd657a994baecc47.hot-update.js.map