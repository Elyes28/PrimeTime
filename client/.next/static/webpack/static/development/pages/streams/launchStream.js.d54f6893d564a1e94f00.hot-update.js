...
var JoinScreen = function JoinScreen(_ref) {
  ...
  var _useState = Object(react__WEBPACK_IMPORTED_MODULE_0__["useState"])(JSON.parse(localStorage.getItem('user')).role),
      role = _useState[0],
      setRole = _useState[1];

  var _useEffect = Object(react__WEBPACK_IMPORTED_MODULE_0__["useEffect"])(function () {
    setRole();
    ...
    if (role == "musician") document.getElementById("showskill").src = "http://localhost:3001/react-rtc-demo?streamerName=" + JSON.parse(localStorage.getItem('user')).firstName + " " + JSON.parse(localStorage.getItem('user')).lastName + "&meetId=create&streamerId=" + JSON.parse(localStorage.getItem('user'))._id;
      ...
      expiration = _useEffect[0],
      setExpiration = _useEffect[1];
...
//# sourceMappingURL=launchStream.js.d54f6893d564a1e94f00.hot-update.js.map