...
var PortfolioDetail2 = function PortfolioDetail2() {
      ...
      return _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_8___default.a.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              return _context.abrupt("return", axios__WEBPACK_IMPORTED_MODULE_12___default.a.get("http://localhost:5000/stream/getStreamByName/" + JSON.parse(localStorage.getItem("user"))["firstName"] + " " + JSON.parse(localStorage.getItem("user"))["lastName"]).then(function (res) {
  ...
  var _useState4 = Object(react__WEBPACK_IMPORTED_MODULE_10__["useState"])(),
      streamer = _useState4[0],
      setStreamer = _useState4[1];

  var getStream = /*#__PURE__*/function () {
    var _ref2 = Object(_babel_runtime_corejs2_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_9__["default"])( /*#__PURE__*/_babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_8___default.a.mark(function _callee2(para) {
      return _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_8___default.a.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              return _context2.abrupt("return", axios__WEBPACK_IMPORTED_MODULE_12___default.a.get("http://localhost:5000/user/getCurrentStream/" + para).then(function (res) {
  ...
  }), _database__WEBPACK_IMPORTED_MODULE_14__["PortfolioDetail1Data"].map(function (data, i) {
    return __jsx("div", {
      className: "item",
      key: i,
      __self: _this,
...
//# sourceMappingURL=channel.js.93d2b8b6e99e8b61b076.hot-update.js.map