          ...
          switch (_context.prev = _context.next) {
            case 0:
              return _context.abrupt("return", axios__WEBPACK_IMPORTED_MODULE_12___default.a.get("http://localhost:5000/user/getCurrentStream/" + para).then(function (res) {
                ...
                console.log(para);
                axios__WEBPACK_IMPORTED_MODULE_12___default.a.get("http://localhost:5000/stream/getStreamById/" + para); //     .then(res => {
                //         setStream(res.data);
...
//# sourceMappingURL=channel.js.7aed5db64fea1f72fa3a.hot-update.js.map