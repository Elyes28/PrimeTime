...
var Banner = function Banner() {
  ...
  var sidesection = function sidesection() {
    if (!sideSection) {
      setSideSection(true);
      document.querySelector('.profile-section').classList.add('d-block');
    } else {
      setSideSection(false);
      document.querySelector('.profile-section').classList.remove('d-block');
    }
  };
...
//# sourceMappingURL=index.js.d4818fce2d8f3ea2629c.hot-update.js.map