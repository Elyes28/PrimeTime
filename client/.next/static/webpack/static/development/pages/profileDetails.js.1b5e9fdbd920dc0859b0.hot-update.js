...
var PortfolioDetail7 = function PortfolioDetail7() {
      ...
      return _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_9___default.a.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              return _context2.abrupt("return", axios__WEBPACK_IMPORTED_MODULE_14___default.a.get("http://localhost:5000/user/getCoursesByUserId/" + JSON.parse(localStorage.getItem("user"))["_id"]).then(function (res) {
                setCourses(res.data);
              })["catch"](function (error) {
                console.log(error);
              }));
  ...
  var _us = us,
      _us2 = Object(_babel_runtime_corejs2_helpers_esm_slicedToArray__WEBPACK_IMPORTED_MODULE_7__["default"])(_us, 2),
      loading = _us2[0],
      setLoading = _us2[1];
  ...
  }), " ")), editable ? __jsx(react__WEBPACK_IMPORTED_MODULE_11___default.a.Fragment, null, __jsx("div", {
  ...
  }, user["role"] == "musician" ? __jsx(next_link__WEBPACK_IMPORTED_MODULE_18___default.a, {
...
//# sourceMappingURL=profileDetails.js.1b5e9fdbd920dc0859b0.hot-update.js.map