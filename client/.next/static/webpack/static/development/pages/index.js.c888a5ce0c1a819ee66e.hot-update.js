...
var Popup = function Popup() {
  ...
  var signin = function signin() {
    ...
    if (buttonValue == "login") axios__WEBPACK_IMPORTED_MODULE_11___default.a.post("http://localhost:5000/user/signin", {
      email: log,
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_9__["useEffect"])(function () {
    if (JSON.parse(localStorage.getItem("user"))) setButtonValue('logout');else setButtonValue('login');
  }, []); //
...
//# sourceMappingURL=index.js.c888a5ce0c1a819ee66e.hot-update.js.map