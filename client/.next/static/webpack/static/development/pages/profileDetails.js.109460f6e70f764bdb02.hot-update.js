...
var PortfolioDetail7 = function PortfolioDetail7() {
      ...
      return _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_8___default.a.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              return _context.abrupt("return", axios__WEBPACK_IMPORTED_MODULE_13___default.a.get("http://localhost:5000/user/getCoursesByUserId/" + JSON.parse(localStorage.getItem("user"))["role"]).then(function (res) {
                setCourses(res.data);
  ...
  }, user["role"] == "musician" ? __jsx(next_link__WEBPACK_IMPORTED_MODULE_16___default.a, {
  ...
  }, __jsx(_components_StreamCard__WEBPACK_IMPORTED_MODULE_15__["default"], {
    __self: _this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 376,
...
//# sourceMappingURL=profileDetails.js.109460f6e70f764bdb02.hot-update.js.map